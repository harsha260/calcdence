...
class _OverallDetailScreenState extends State<OverallDetailScreen> {
  ...
  bool _attendMode =
      true; // true = "I will attend N days", false = "I will skip N days"
  int _days = 1;
  ...
  int _calculateSkipDays(double targetPct) {
    ...
    for (int day = 1; day <= 60; day++) {
      ...
      currentConducted += periods;
      if ((currentAttended / currentConducted * 100) < targetPct)
        return day - 1;
    }
    return 30;
  }
                ...
                horizontalLines: [
                  HorizontalLine(
                    ...
                    label: HorizontalLineLabel(
                      ...
                      labelResolver: (line) =>
                          'Target ${context.read<TargetProvider>().target.toInt()}%',
  ...
  Widget _statBox(String title, String value, IconData icon, Color iconColor) {
    return Column(
      children: [
          ...
          children: [
            ...
            Consumer<TargetProvider>(
              builder: (context, targetProv, _) {
                ...
                final isAbove = widget.percentage >= target;
                final days = isAbove
                    ? _calculateSkipDays(target)
                    : _calculateRequiredDays(target);
        ...
        child: Column(
          ...
          children: [
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                return ToggleButtons(
                  ...
                  onPressed: (i) => setState(() => _attendMode = i == 0),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        '$d',
                        style: TextStyle(
                          color: _days == d ? Colors.white : Colors.deepPurple,
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: (projectedGood ? Colors.green : Colors.red).withValues(
                  alpha: 0.1,
                ),
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        'Overall after $_days day${_days == 1 ? "" : "s"}',
                        style: TextStyle(
